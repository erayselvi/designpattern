...
{
    class Ucak_Otel_Fabrikasi:ISoyutFabrika
    {
        ...
        public Ucak_Otel_Fabrikasi(string ad, string sad, string tc, string nereden, string nereye, DateTime gidistarihi, DateTime donustarihi, string sirketadi)
        {
